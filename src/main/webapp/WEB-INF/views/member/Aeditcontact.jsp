	...
	<div class="sw-lg-70 min-h-50 bg-foreground d-flex justify-content-center align-items-center shadow-deep py-5 full-page-content-right-border">
		<div class="sw-lg-50 px-5 justify-content-center align-items-center">
			<div class="mb-5 justify-content-center align-items-center">
				<h2 class="cta-1 mb-0 text-primary justify-content-center align-items-center d-flex">연락처 수정</h2>
				<h2 class="cta-1 text-primary"></h2>
			</div>
<form action="/member/updatecontact/${MContactDto.contactid}" method="post" enctype="multipart/form-data" class="card mb-5 tooltip-end-top" id="contactForm" novalidate="novalidate" data-select2-id="contactForm">
<div class="card-body" data-select2-id="17">
<p class="text-alternate mb-4">수정할 연락처 정보를 입력하세요.</p>
...
<input class="form-control" value="${MContactDto.name}" name="name" >
</div>
<div class="mb-3 filled">
...
<input class="form-control" value="${MContactDto.phonenumber}" name="phonenumber">
</div>
<div class="mb-3 filled">
<textarea class="form-control" name="address" rows="2">${MContactDto.address}</textarea>
...
<select class="form-control select2-hidden-accessible" name="moimid" id="Group" data-select2-id="Group" tabindex="-1" aria-hidden="true">
...
-->
<input type="file" value="${MContactDto.photo}" placeholder = "${MContactDto.photo}" name="file" class="form-control">
${MContactDto.photo}
</div>     
<div class="card-footer border-0 pt-0 d-flex justify-content-center align-items-center">
<div>
<a href = "/member/updatecontact">
